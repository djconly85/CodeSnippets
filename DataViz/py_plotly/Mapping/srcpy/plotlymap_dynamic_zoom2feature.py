...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep 21 19:37:21 2020
...
def get_plotting_zoom_level_and_center_coordinates_from_lonlat_tuples(
    ...
    '''NOTE - in theory do not need planar module. Can instead just get following coords:
        (minx, miny), (minx, maxy), (maxx, maxy), (maxx, miny), then get width and height
        as (maxx - minx) and (maxy - miny), then use these distances to get area needed
        as input for np.interp function below.'''
